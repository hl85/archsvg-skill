...
export const TOKENS = {
  light: {
    ...
    grid: '#e2e8f0',
    roles: {
      control: { fill: '#fdf4ff', stroke: '#a855f7', text: '#7e22ce' },
      capability: { fill: '#f0fdf4', stroke: '#22c55e', text: '#166534' },
      interaction: { fill: '#eff6ff', stroke: '#3b82f6', text: '#1e40af' },
      warn: { fill: '#fef2f2', stroke: '#ef4444', text: '#b91c1c' },
      neutral: { fill: '#f8fafc', stroke: '#94a3b8', text: '#334155' },
    },
  },
  dark: {
    canvas: '#0f172a',

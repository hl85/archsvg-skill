// 组合质量检查（11 项）：把本项目的 LayoutResult 适配成 geometry.mjs 各 collector 期望的入参形状后调用。
//
// 适配层说明：
...
export const COMPOSITION_CHECK_NAMES = [
  'finite_svg', 'node_overlap', 'node_text_in_box', 'text_not_truncated',
